...
For previous versions of the documentation, please visit `https://js-sdsl.github.io/js-sdsl/previous/v${version}/index.html` like [this](https://js-sdsl.github.io/js-sdsl/previous/v4.1.5/index.html).
