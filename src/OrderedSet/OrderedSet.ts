...
import { Base, ContainerIterator, initContainer } from "../Base/Base";
...
class OrderedSet<T> implements Base {
    ...
    private findSubTreeMinNode:
        (curNode: TreeNode<T, undefined>) => TreeNode<T, undefined> = (curNode: TreeNode<T, undefined>) => {
    ...
    private findSubTreeMaxNode:
        (curNode: TreeNode<T, undefined>) => TreeNode<T, undefined> =
        (curNode: TreeNode<T, undefined>) => {
            if (!curNode || curNode.key === undefined) throw new Error("unknown error");
            return curNode.rightChild ? this.findSubTreeMaxNode(curNode.rightChild) : curNode;
        }
    private inOrderTraversal:
        (curNode: TreeNode<T, undefined> | undefined, callback: (curNode: TreeNode<T, undefined>) => boolean) => boolean =
        (curNode: TreeNode<T, undefined> | undefined, callback: (curNode: TreeNode<T, undefined>) => boolean) => {
    ...
    private findInsertPos:
        (curNode: TreeNode<T, undefined>, element: T) => TreeNode<T, undefined> =
        (curNode: TreeNode<T, undefined>, element: T) => {
            if (!curNode || curNode.key === undefined) throw new Error("unknown error");
    ...
    private findElementPos:
        (curNode: TreeNode<T, undefined> | undefined, element: T) => TreeNode<T, undefined> | undefined =
        (curNode: TreeNode<T, undefined> | undefined, element: T) => {
            if (!curNode || curNode.key === undefined) return undefined;
            const cmpResult = this.cmp(element, curNode.key);
            if (cmpResult < 0) return this.findElementPos(curNode.leftChild, element);
            else if (cmpResult > 0) return this.findElementPos(curNode.rightChild, element);
            return curNode;
        }
    private _lowerBound:
        (curNode: TreeNode<T, undefined> | undefined, key: T) => TreeNode<T, undefined> | undefined =
        (curNode: TreeNode<T, undefined> | undefined, key: T) => {
            if (!curNode || curNode.key === undefined) return undefined;
    ...
    private iterationFunc:
        (curNode: TreeNode<T, undefined> | undefined) => Generator<T, void, undefined> =
        function* (this: OrderedSet<T>, curNode: TreeNode<T, undefined> | undefined) {
    ...
    rBegin() {
        return new TreeIterator(this.header.rightChild || this.header, this.header, "reverse");
    }
    rEnd() {
    ...
    eraseElementByValue(value: T) {
        ...
        if (curNode === undefined || curNode.key === undefined || this.cmp(curNode.key, value) !== 0) return;
    ...
    insert(element: T) {
        ...
        if (curNode.key !== undefined && this.cmp(curNode.key, element) === 0) return;

        ++this.length;
        curNode.key = element;

        if (this.header.leftChild === undefined || this.header.leftChild.key === undefined || this.cmp(this.header.leftChild.key, element) > 0) {
            this.header.leftChild = curNode;
        }
        if (this.header.rightChild === undefined || this.header.rightChild.key === undefined || this.cmp(this.header.rightChild.key, element) < 0) {
    ...
    find(element: T) {
        ...
        if (curNode !== undefined && curNode.key !== undefined) return new TreeIterator(curNode, this.header);
        return this.end();
    }
    /**
    ...
    getHeight() {
        ...
        const traversal: (curNode: TreeNode<T, undefined> | undefined) => number =
