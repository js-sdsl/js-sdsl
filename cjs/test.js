...
function testLink(arr) {
    if (arr === void 0) { arr = []; }
    console.log("testLink");
    var myLink = new LinkList_1.default(arr);
    console.log('size =', myLink.size());
    myLink.forEach(function (element, index) {
    ...
    myLink.merge(new LinkList_1.default([2, 5, 6, 7, 555]));
    console.log('size =', myLink.size());
    myLink.forEach(function (element, index) {
        console.log(index, element);
    });
    ...
    myLink.sort(function (x, y) { return x - y; });
    console.log('size =', myLink.size());
    myLink.forEach(function (element, index) {
        console.log(index, element);
    });
...
function testDeque(arr) {
    console.log("testDeque");
    var myDeque = new Deque_1.default(arr);
    console.log('size =', myDeque.size());
    myDeque.forEach(function (element, index) {
        console.log(index, element);
    });
    myDeque.pop_front();
    myDeque.pop_back();
    ...
    myDeque.sort(function (x, y) { return x - y; });
    console.log('size =', myDeque.size());
    myDeque.forEach(function (element, index) {
        console.log(index, element);
    });
